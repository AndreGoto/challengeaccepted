Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ 'http://www.challengeslab.com/', /http:\/\/challenge-lab.herokuapp.*/ ]
  ...
  # config.active_job.queue_name_prefix = "challengeaccepted_#{Rails.env}"
